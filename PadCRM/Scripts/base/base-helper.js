(function () {
  ...
  var JHelper = {
    ...
    showContent: function (url, element) {
      $.get(url, {}, function (res) {
        $(element).html(res);
      })
    },
    initPermission: function () {
      $.get(ajaxUrl.permissionUrl, {}, function (res) {
        $('.permission-nav').append(res);
      })
    },
    onDataBoundShowContent: function () {
      $.each($('[data-showcontent]'), function (index, item) {
        var url = $(item).data('showcontent');
        Maitonn.JHelper.showContent(url, item);
      })
    }
  }
  window.Maitonn = window.Maitonn || {};
  ...
  $(function () {
    Maitonn.JHelper.initPermission();
  })
})()
